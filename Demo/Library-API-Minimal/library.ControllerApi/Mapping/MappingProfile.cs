...
{
    // We just use the constructor and det our mapping there
    public MappingProfile()
    {
        ...
        // It is possible for utoMapper to pick uo the mapping implicitly based on matching name/type
        ...
        // We can reverseMap if we are confident it eill pick it up automatically, or
