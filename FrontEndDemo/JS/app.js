...
// The same catalog shape js/app.js renders - and GET /api/Inventpry returns
// let catalogItems = [
...
async function loadCatalog() {
    ...
    try {
        ...
        // fetch doesn't throw error for/s. This is for stuff like
...
// Event listener let us "listen" for certain actions/states in the HTML page
...
// event that happens within the card. Te card has a button - when it's clicked
...
document.querySelector("#search").addEventListener("input", (e) =>{
    // Grab the string value un the search bar
