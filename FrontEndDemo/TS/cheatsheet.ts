...
let name = "join"; // I actually don't strictly need the type annotation
// but id I try to shove an integer into this variable later, I won't compile.
...
// passing in a singular string to JSON.parce()
...
// Lets make some types and also introduce tuples

// Labled tuple, fixewd elements types
