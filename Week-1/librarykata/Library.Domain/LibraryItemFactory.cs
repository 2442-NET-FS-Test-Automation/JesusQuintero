...
{
    // Our class is responsible dor creating LibraryItems of any type
    // we will use that enum here to make sure users ONLY attemp to create
    // valid types
    ...
    public static LibraryItem Create(
        ...
        string publisher = "Uknown")
    {
        // This method is going to use a swith to call the correct constructor
        switch (kind)
        {
            case ItemKind.Book:
                return new Book(title,author,copies);

            case ItemKind.RerefenceBook:
            ...
            default: // No idea how you'd get here.
                throw new LibraryException($"Uknown item kind: {kind}");
