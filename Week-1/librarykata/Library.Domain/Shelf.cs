...
// I don't want to be limited to LibraryItems, I can put like commputer hardware or supplies on the shelf
namespace Library.Domain;

// T is the standard placeholder pof ... "some type" that we will determinate later
...
public class Shelf<T>
{
    ...
    private int used; // As things are added to my array, the Shelf object tracks how
                      // slots of the sheld are being used internally here.
    ...
    // Exposing some arrray properties as needed
    ...
    {
        if (used == _slots.Length) return false;
